...
# Load model
with open('model/fish_SVM.pkl', 'rb') as file:
    fish_model_svm = pickle.load(file)
with open('model/pumpkin_SVM.pkl', 'rb') as file:
    pumpkin_model_svm = pickle.load(file)
with open('model/fruit_SVM.pkl', 'rb') as file:
    fruit_model_svm = pickle.load(file)
with open('model/fish_PCP.pkl', 'rb') as file:
    fish_model_pcp = pickle.load(file)
with open('model/pumpkin_PCP.pkl', 'rb') as file:
    pumpkin_model_pcp = pickle.load(file)
with open('model/fruit_PCP.pkl', 'rb') as file:
    fruit_model_pcp = pickle.load(file)
with open('model/fish_RF.pkl', 'rb') as file:
    fish_model_rf = pickle.load(file)
with open('model/pumpkin_RF.pkl', 'rb') as file:
    pumpkin_model_rf = pickle.load(file)
with open('model/fruit_RF.pkl', 'rb') as file:
